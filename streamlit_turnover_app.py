...
st.title('Employee Turnover Prediction Test')
st.write('Use the following form to submit data for a prediction.')

# Create form for user input
form = st.form(key='my_form')

age = form.number_input('Age of employee', min_value=0, max_value=75, value=25)
numberPriorJobs = form.number_input('Number of prior jobs ', min_value=0, max_value=75, value=0)
